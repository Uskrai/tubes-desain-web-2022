        ...
        return(
            <footer className="p-4 bg-white sm:p-6 dark:bg-gray-900">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="text-gray-600 dark:text-gray-400">
                                ...
                                <li className="mb-4">
                                    <a href="#" className="hover:underline">Ketentuan Pemakaian</a>
                                </li>
                                <li className="mb-4">
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">Copyright © <a href="https://flowbite.com/" className="hover:underline">CookiPad Inc.</a>
                    </span>
