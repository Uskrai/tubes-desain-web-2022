                ...
                <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
                    <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                        ...
                        <div className="flex items-center lg:order-2">
                            ...
                            {/* <span className="self-center text-l whitespace-nowrap transition duration-300 ease-in-out dark:text-white hover:scale-110">Log In</span> */}
                            {/* {login} */}
                            {(data !== null) ? (
                                <button className="flex items-center pl-5" onClick={this.logout}>
                                    <span className="self-center text-l whitespace-nowrap transition duration-300 ease-in-out dark:text-white hover:scale-110">{data}</span>
                                </button>
                            ) : (
                                <a href="/login" className="flex items-center pl-5">
                                    <span className="self-center text-l whitespace-nowrap transition duration-300 ease-in-out dark:text-white hover:scale-110">Log In</span>
                                </a>
                            )}
