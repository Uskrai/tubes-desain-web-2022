...
export default class RecipeDescription extends Component {
  render() {
    return (
      <div className="flex flex-row-reverse bg-gray-700 m-3">
        <div
        ...
        <div className="grid grid-cols-2 gap-8">
          ...
          <div className="flex flex-col gap-4 justify-center items-start text-left p-8">
            <div className="flex  justify-between w-full">
                <h1 className="text-2xl font-bold">Beef Teriyaki (ala Hokben)</h1>
...
<path d="M16 15.92L0 0H32L16 15.92Z" fill="#D9D9D9"/>
            ...
            <div className="flex flex-col gap-2">
              ...
              <a href="#" className="flex items-center gap-3">
                ...
                <h2 className="font-medium text-xl">Alfredo Press</h2>
              </a>
            </div>
